        ...
        <div class="container">
            ...
            {{-- <form action="create" method="post"> --}}
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="productDesc" placeholder="Enter Product Description" name="description">
                </div>
                <span style="color:red">@error('description'){{$message}} @enderror</span><br><br>
                <div class="form-group">
                    <label for="producrPrice">Product Price</label>
                    <input type="text" class="form-control" id="producrPrice" placeholder="Enter Product Price" name="price">
                </div>
                <span style="color:red">@error('email'){{$message}} @enderror</span><br><br>
                <div class="form-group">
                    <label for="productCategory">Product Category</label>
                    <input type="text" class="form-control" id="productCategory" placeholder="Enter Product Category" name="category_name">
                </div>
                <span style="color:red">@error('email'){{$message}} @enderror</span><br><br>
